...
const Footer = () => {
  return (
    <div>
      <footer className="w-full  flex flex-col items-center justify-center bg-gradient-to-br from-[#D7E8F9] to-[#f4f6f9e7] text-base-content lg:px-30 pt-24 pb-20">
        <div className="flex lg:flex-row flex-col mx-auto gap-10 w-[90%] justify-center items-start">
          <aside className="lg:w-[40%] flex items-start flex-col gap-2 lg:mr-10 mr-0">
          ...
          <div className="lg:w-[35%] flex flex-col gap-3 lg:mt-1 mt-0">
          ...
          <div className="lg:w-[20%] flex lg:flex-row flex-col lg:gap-20 gap-10 lg:mt-0">
